...
firebase.initializeApp({
  ...
  apiKey: "AIzaSyDgduoBjRF9_AO3Aw-zhPq2_n3GBu2zTRg",
  authDomain: "fast-talk-reactfirechat.firebaseapp.com",
  projectId: "fast-talk-reactfirechat",
  storageBucket: "fast-talk-reactfirechat.appspot.com",
  messagingSenderId: "1068504258816",
  appId: "1:1068504258816:web:aa8b830604faa7777ffbe5",
});
...
function App() {
  ...
  const signInWithGoogle = async () => {
    // Recebe o objeto de autenticacao provido pela Google
    const provider = new firebase.auth.GoogleAuthProvider();
    // Seta a linguagem padrao do navegador
      ...
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          ...
          <p className="mb-8 text-lg text-center">
            Jeito facil de conversar com seus contatos.
          </p>
          <button
            onClick={signInWithGoogle}
            className="rounded shadow-button pl-6 pr-8 py-3 bg-white hover:bg-gray-50 text-gray-600 font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-blue-600 focus:ring-opacity-75"
          >
            <svg
              viewBox="5 -5 30 30"
      ...
      >
        ...
        <div className="flex items-center">
          {user ? (
            <button
              onClick={signOut}
              className="uppercase text-sm font-medium text-blue-600 hover:text-white tracking-wide hover:bg-blue-600 bg-transparent rounded py-2 px-4 mr-4 focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75 transition-all"
            >
              Desconectar
            </button>
          ) : null}
